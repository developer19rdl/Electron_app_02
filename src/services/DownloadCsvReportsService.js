...
export const DownloadDeviceReport = (data, successCallback, errorCallBack) => {
  const { fromDate, toDate, locationId, deviceId } = data;
  return _fetchServiceDownloadCsvData(`reports/downloadReportAsExcel?fromDate=${fromDate}&toDate=${toDate}&locationId=${locationId}&deviceId=${deviceId}`, 'GET', {}, successCallback, errorCallBack, `SensorReport.xlsx`, 'download');
};