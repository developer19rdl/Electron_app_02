...
const ScadaView = () => {
    ...
    useEffect(() => {
        ...
        const socket = io("http://192.168.31.55:8000/", {
        ...
        setScadaTabs((prevTabs) => {
            ...
            scadaData.forEach((item) => {
                ...
                const imageUrl = item.image?.startsWith("http")
                    ...
                    : `http://192.168.31.55:8000/Mardah/Pump_node_server/public/${item.image}`;
    ...
    const handleAddMarker = () => {
        ...
        //     : tabImage;
        const imagePathToSend = tabImage.startsWith("http://192.168.31.55:8000/")
            ? tabImage.replace("http://192.168.31.55:8000/", "")
            : tabImage;
